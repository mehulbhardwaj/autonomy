...
class GitHubIssueCreator:
    ...
    def create_milestone(self, title: str, description: str, due_on: Optional[str] = None) -> Optional[int]:
    ...
    def create_issues_from_plan(self, plan_file: str) -> None:
        ...
        print(f"Visit https://github.com/{self.owner}/{self.repo}/issues to view created issues")
        print(f"Visit https://github.com/{self.owner}/{self.repo}/milestones to view milestones")
